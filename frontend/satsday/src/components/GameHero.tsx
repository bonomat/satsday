            ...
            <span className="bg-gradient-to-r from-primary via-orange-500 to-yellow-500 bg-clip-text text-transparent">
              Provably Fair
                    ...
                    <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        Experience transparent gaming powered by Bitcoin with Ark settlement layer.
                        Every outcome is verifiable, every game is provably fair.
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
                    <Card
                        className="bg-gradient-to-br from-card to-card/50 border-primary/20 hover:border-primary/40 transition-all duration-300">
                        <CardContent className="pt-6 pb-6 text-center space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                Every game outcome is verifiable using Bitcoin transaction hashes and cryptographic
                                proofs.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card
                        ...
                        <CardContent className="pt-6 pb-6 text-center space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                Fast and efficient settlements using Ark layer while maintaining Bitcoin security.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card
                        ...
                        <CardContent className="pt-6 pb-6 text-center space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                Various game types with different strategies and payout structures to choose from.
                            </p>
                        </CardContent>
                    </Card>
                </div>
